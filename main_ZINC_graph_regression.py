        ...
        with tqdm(range(params['epochs'])) as t:
            for epoch in t:
                ...
                wandb.log({"train loss": epoch_train_loss, "val loss": epoch_val_loss,
                           "train MAE": epoch_train_mae, "val acc": epoch_val_mae,
                           "test mae": epoch_test_mae, "lr": optimizer.param_groups[0]['lr'],
                           "epoch": epoch})
...
def main():    
    ...
    parser.add_argument("--wandb_project", type=str, default="Part-II-pytorch-ZINC")
    parser.add_argument("--wandb_run_name", type=str, default="ZINC")
